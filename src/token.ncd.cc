...
static char const *getParserTokenName(unsigned long c) {
      switch(c) { 
       ...
       case TOKEN_DOTMULT: return "DOTMULT";
       case TOKEN_DOTDIV: return "DOTDIV";
       ...
       case TOKEN_DOUBLE_DIV: return "DOUBLE_DIV";
       case TOKEN_C_COMMENT_START: return "C_COMMENT_START";
       case TOKEN_C_COMMENT_END: return "C_COMMENT_END";
    ...
    static char const *getParserTokenComment(unsigned long c) {
      switch(c) { 
       ...
       case TOKEN_DOTMULT: return "";
       case TOKEN_DOTDIV: return "";
       ...
       case TOKEN_DOUBLE_DIV: return "";
       case TOKEN_C_COMMENT_START: return "";
       case TOKEN_C_COMMENT_END: return "";
    ...
    static ParserToken getParserTokenValue(char const *name, int *res) {
       ...
       } else if (strcasecmp("DOTMULT", name) == 0
          || strcasecmp("TOKEN_DOTMULT", name) == 0) {
          return TOKEN_DOTMULT;
       } else if (strcasecmp("DOTDIV", name) == 0
          || strcasecmp("TOKEN_DOTDIV", name) == 0) {
          return TOKEN_DOTDIV;
       } else if (strcasecmp("DOTBACKSLASH", name) == 0
          || strcasecmp("TOKEN_DOTBACKSLASH", name) == 0) {
          return TOKEN_DOTBACKSLASH;
       } else if (strcasecmp("DOTPOW", name) == 0
          || strcasecmp("TOKEN_DOTPOW", name) == 0) {
          return TOKEN_DOTPOW;
       ...
       } else if (strcasecmp("DOUBLE_DIV", name) == 0
          || strcasecmp("TOKEN_DOUBLE_DIV", name) == 0) {
          return TOKEN_DOUBLE_DIV;
       } else if (strcasecmp("C_COMMENT_START", name) == 0
          || strcasecmp("TOKEN_C_COMMENT_START", name) == 0) {
          return TOKEN_C_COMMENT_START;
       } else if (strcasecmp("C_COMMENT_END", name) == 0
          || strcasecmp("TOKEN_C_COMMENT_END", name) == 0) {
    ...
    static ParserToken getParserToken(int which) {
      switch(which) { 
       ...
       case 104: return TOKEN_DOTMULT;
       case 105: return TOKEN_DOTDIV;
       ...
       case 116: return TOKEN_DOUBLE_DIV;
       case 117: return TOKEN_C_COMMENT_START;
       case 118: return TOKEN_C_COMMENT_END;
       case 119: return TOKEN_IGNORE;
       case 120: return TOKEN_LAST;
       default: break;
      }
