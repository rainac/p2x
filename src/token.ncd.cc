...
static char const *getParserTokenName(unsigned long c) {
    ...
    static ParserToken getParserToken(int which) {
      switch(which) { 
       ...
       case 104: return TOKEN_LAST; 
       default: break;
      }
      std::cerr << "error: ParserToken constant index " << which << " out of range\n";
      return TOKEN_EOF;
    }
