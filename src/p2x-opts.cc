...
const char *gengetopt_args_info_full_help[] = {
  ...
  "  -i, --ignore=Token            Add an item to ignore",
  "  -b, --binary=Token[=prec]     Add a binary operator",
  "  -r, --right=Token[=prec]      Add a right associative operator",
  "  -u, --unary=Token[=prec]      Add a unary operator",
  "      --postfix=Token[=prec]    Add a postfix operator",
  "  -I, --item=Token              Add an item",
