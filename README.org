...
[[file:examples/configs/cdecls]] and the input text file
...
<code-xml xmlns='http://johannes-willkomm.de/xml/code-xml/' xmlns:c='http://johannes-willkomm.de/xml/code-xml/attributes/' xmlns:i='http://johannes-willkomm.de/xml/code-xml/ignore/'>
 <c:version name='P2X' id='c4919887' major='0' minor='7' patch='0'><!-- P2X version 0.7.0 (c4919887) --></c:version>
 <ROOT>
  <null/>
  <MULT>
   <JUXTA>
...
As a more complex example try parsing an entire program, and some of
the options:
